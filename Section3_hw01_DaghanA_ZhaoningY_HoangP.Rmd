...
```{r}
plotsugroup.pi.ci <- function(newdata, mod.fit.obj, Party, Race){
  ...
  legend(x=80, y=0.95, legend = c("model", "95% C.I."),
                                 lty = c("solid", "dotdash"), col = c("red", "blue"), bty = "n")
}
```

## Estimated probability for sanders_preference for different voter groups

###  White voters

```{r}
# White Democratic
plotsugroup.pi.ci(newdata=dt, mod.fit.obj=logit.mod.full, Party= "D", Race = "1")

# White Independent
plotsugroup.pi.ci(newdata=dt, mod.fit.obj=logit.mod.full, Party= "I", Race = "1")

# White Republican
plotsugroup.pi.ci(newdata=dt, mod.fit.obj=logit.mod.full, Party= "R", Race = "1")
```
### Non-white voters

```{r}
# Non-white Democratic
plotsugroup.pi.ci(newdata=dt, mod.fit.obj=logit.mod.full, Party= "D", Race = "0")

# Non-white Independent
plotsugroup.pi.ci(newdata=dt, mod.fit.obj=logit.mod.full, Party= "I", Race = "0")

# Non-white Republican
plotsugroup.pi.ci(newdata=dt, mod.fit.obj=logit.mod.full, Party= "R", Race = "0")
```
